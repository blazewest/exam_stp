...
class PurchaseReport(models.TransientModel):
    ...
    sum_don_vi = fields.Char(string='tổng dv tham gia ', required=False)
    sum_exam = fields.Integer(string='tổng bài thi ', required=False)
    high_score = fields.Float(string='Điểm cao nhất ', required=False)
    sum_partner = fields.Integer(string='tổng số người tham gia ', required=False)

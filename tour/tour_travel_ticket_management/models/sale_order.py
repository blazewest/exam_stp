...
class SaleOrder(models.Model):
    ...
    def get_package_visa_lines(self):
        visa_lines = []
        template = self.sale_order_template_id.with_context(lang=self.partner_id.lang)

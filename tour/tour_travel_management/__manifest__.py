#  See LICENSE file for full copyright and licensing details.
{
    ...
    "depends": ["sale_margin", "purchase", "account_tax_python"],
    "summary": """
    ...
    "data": [
        ...
        "data/package_nonspecific_cron.xml",
        "data/non_specific_tourdays_demo.xml",
        ...
        "data/email_template_sale_confirm.xml",
        "views/account_views.xml",
        "report/account_invoice_report.xml",
    ],
    "assets": {
        "web.assets_backend": ["tour_travel_management/static/src/scss/package.scss"],
    },
    "demo": [
    ...
    "images": ["static/src/img/Banner_tour_travel_management.png"],
    "installable": True,
    "application": True,
    "price": 57,
    "currency": "EUR",
